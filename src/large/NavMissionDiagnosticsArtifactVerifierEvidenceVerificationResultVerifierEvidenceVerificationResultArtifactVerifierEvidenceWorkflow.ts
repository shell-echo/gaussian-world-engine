...
import {createRuntimeNavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceVerificationControl as createVerificationControl} from "./NavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceVerificationControl.js";
import type {RuntimeNavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceVerificationResult as EvidenceVerification} from "./NavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceVerificationContract.js";
...
export type RuntimeNavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceWorkflowOptions =
  ...
  Omit<EvidenceOptions,"maxPreviewCharacters"|"onCreate"|"onArtifactDownload"|"onDownloadAll"|"onArtifactCopy"> & {
    ...
    expectedVerificationResultArtifactVerifierEvidenceVerification?:Verification;
    expectedVerificationResultArtifactVerifierEvidenceSource?:Source;
    expectedVerificationResultArtifactVerifierEvidenceInputChecksumHex?:string;
    onVerificationResultArtifactVerifierEvidenceVerify?:(result:EvidenceVerification,evidence:Evidence)=>void;
  };
...
export function createRuntimeNavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceWorkflow(
  ...
  const {
    ...
    onVerificationResultArtifactVerifierEvidenceVerify:evidenceVerify,
    ...parentOptions
  }=options;
  const workflow=createVerifiedWorkflow(verification,provenance,{
    ...
    onVerificationResultVerifierEvidenceVerificationResultVerify:(result:Verification,source:Source)=>{
      ...
      void render(root,current,result,source,options,evidenceVerify);
    },
  });
...
async function render(
  ...
  source:Source,
  options:RuntimeNavMissionDiagnosticsArtifactVerifierEvidenceVerificationResultVerifierEvidenceVerificationResultArtifactVerifierEvidenceWorkflowOptions,
  evidenceVerify:((result:EvidenceVerification,evidence:Evidence)=>void)|undefined,
):Promise<void>{
  ...
  root.querySelector<HTMLElement>("[data-verification-result-artifact-verifier-evidence-verifier]")?.remove();
  ...
  const control=createVerificationControl(evidence,{
    expectedVerification:options.expectedVerificationResultArtifactVerifierEvidenceVerification??verification,
    expectedSource:options.expectedVerificationResultArtifactVerifierEvidenceSource??source,
    ...(options.expectedVerificationResultArtifactVerifierEvidenceInputChecksumHex===undefined?{}:{expectedInputResultChecksumHex:options.expectedVerificationResultArtifactVerifierEvidenceInputChecksumHex}),
    onVerify:(result,artifactSet)=>evidenceVerify?.(result,artifactSet),
    ...(options.onStatus===undefined?{}:{onStatus:options.onStatus}),
  });
  control.dataset.verificationResultArtifactVerifierEvidenceVerifier="true";
  root.append(control);
}
